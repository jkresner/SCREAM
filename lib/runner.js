...
global.SPEC = function(name) {
  var {Config} = _RUNNER.opts
  describe.call(Config.specCtx, '', function() {
    before(function() { Config.specCtx.start = new Date })
    after(function() { console.log(`    TIME(ms): ${new Date()-Config.specCtx.start}`.spec) })
