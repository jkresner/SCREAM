module.exports = function() {
  ...
  var _call = (httpCall, opts, cb) => {
    ...
    if (opts.hasOwnProperty('unauthenticated') || opts.hasOwnProperty('authenticated'))
      console.log("[DEPRECATED] scream.http opts.(un)authenticated".yellow)
  ...
  global.PAGE = (url, opts, cb) =>
    _call(http(global.APP).get(url), assign({ contentType: /text/ }, opts||{}), cb)
