module.exports = function() {
  ...
  var short = { get:'GET',post:'POS',delete:'DEL',put:'PUT' }
  ...
  var _call = (httpCall, opts, cb) => {
    ...
    if (OPTS.config.verbose)
      console.log(`${short[httpCall.method]}${httpCall.url.replace('http://127.0.0.1','')}`.white.dim, (JSON.stringify(opts)||'').gray.dim)
