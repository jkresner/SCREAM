module.exports = function(done) {
  ...
  var _db = {
    ...
    removeDocs(modelName, query, cb) {
      collection(modelName).deleteMany(query, (e,r)=>cb(e||r))
    },

    clear(modelName, cb) {
      collection(modelName).deleteMany({}, e => cb(e))
    },
  ...
  let {url, ops} = cfg.mongo
  ops = Object.assign(ops||{}, { useUnifiedTopology: true })
  mongodb.MongoClient.connect(url, ops, (e, client) => {
    if (e) throw e
